...
## 4f
# e e t u
V_eetu = Vertex(name = 'V_eetu',
             particles = [ P.e__plus__, P.e__minus__, P.u__tilde__, P.t ],
             color = ['Identity(3,4)'],
             lorentz = [ L.VLL, L.VLR, L.VRL, L.VRR, L.SRR, L.SLL, L.TRR, L.TLL ],
             couplings = {(0,0):C.uVLL, (0,1):C.uVLR, (0,2):C.uVRL, (0,3):C.uVRR, (0,4):C.uSRR, (0,5):C.uSLL, (0,6):C.uTRR, (0,7):C.uTLL })
V_eeut = Vertex(name = 'V_eeut',
             particles = [ P.e__plus__, P.e__minus__, P.t__tilde__, P.u ],
             color = ['Identity(3,4)'],
             lorentz = [ L.VLL, L.VLR, L.VRL, L.VRR, L.SRR, L.SLL, L.TRR, L.TLL ],
             couplings = {(0,0):C.uVLLbar, (0,1):C.uVLRbar, (0,2):C.uVRLbar, (0,3):C.uVRRbar, (0,4):C.uSRRbar, (0,5):C.uSLLbar, (0,6):C.uTRRbar, (0,7):C.uTLLbar })

# e e t c
V_eetc = Vertex(name = 'V_eetc',
             particles = [ P.e__plus__, P.e__minus__, P.c__tilde__, P.t ],
             color = ['Identity(3,4)'],
             lorentz = [ L.VLL, L.VLR, L.VRL, L.VRR, L.SRR, L.SLL, L.TRR, L.TLL ],
             couplings = {(0,0):C.cVLL, (0,1):C.cVLR, (0,2):C.cVRL, (0,3):C.cVRR, (0,4):C.cSRR, (0,5):C.cSLL, (0,6):C.cTRR, (0,7):C.cTLL })
V_eect = Vertex(name = 'V_eect',

...
# 4f vector
VLL = Lorentz(name = 'VLL',
                spins = [ 2, 2, 2, 2 ],
                structure = 'Gamma(-5,2,-1)*ProjM(-1,1)*Gamma(-5,4,-3)*ProjM(-3,3)')
VLR = Lorentz(name = 'VLR',
                spins = [ 2, 2, 2, 2 ],
                structure = 'Gamma(-5,2,-1)*ProjM(-1,1)*Gamma(-5,4,-3)*ProjP(-3,3)')
VRL = Lorentz(name = 'VRL',
                spins = [ 2, 2, 2, 2 ],
                structure = 'Gamma(-5,2,-1)*ProjP(-1,1)*Gamma(-5,4,-3)*ProjM(-3,3)')
VRR = Lorentz(name = 'VRR',
                spins = [ 2, 2, 2, 2 ],
                structure = 'Gamma(-5,2,-1)*ProjP(-1,1)*Gamma(-5,4,-3)*ProjP(-3,3)')
# 4f scalar
SRR = Lorentz(name = 'SRR',
                spins = [ 2, 2, 2, 2 ],
                structure = 'ProjP(2,1)*ProjP(4,3)')
SLL = Lorentz(name = 'SLL',
                spins = [ 2, 2, 2, 2 ],
                structure = 'ProjM(2,1)*ProjM(4,3)')
# 4f tensor
# Note Sigma is defined in aloha/aloha_object.py as i/4[Ga(mu),Ga(nu)]
# a factor of 2 is therefore introduced in the tensor couplings
# to recover the i/2[Ga(mu),Ga(nu)] definition.
TRR = Lorentz(name = 'TRR',
                spins = [ 2, 2, 2, 2 ],
                structure = '2*Sigma(-5,-6,2,-1)*ProjP(-1,1)*2*Sigma(-5,-6,4,-3)*ProjP(-3,3)')
TLL = Lorentz(name = 'TLL',
                spins = [ 2, 2, 2, 2 ],
                structure = '2*Sigma(-5,-6,2,-1)*ProjM(-1,1)*2*Sigma(-5,-6,4,-3)*ProjM(-3,3)')
#RR1 = Lorentz(name = 'TRR1',
#                spins = [ 2, 2, 2, 2 ],
#                structure =	'Gamma(-5,2,-2)*Gamma(-6,-2,-1)*ProjP(-1,1)*Gamma(-5,4,-4)*Gamma(-6,-4,-3)*ProjP(-3,3)')
#RR2 = Lorentz(name = 'TRR2',
#                spins = [ 2, 2, 2, 2 ],
#                structure =	'Gamma(-5,2,-2)*Gamma(-6,-2,-1)*ProjP(-1,1)*Gamma(-6,4,-4)*Gamma(-5,-4,-3)*ProjP(-3,3)')
